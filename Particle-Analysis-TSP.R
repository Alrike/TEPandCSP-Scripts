...
#filterdir<-"C:/Users/lscheidemann/Desktop/Dokumrnte/imageJ-stuff/Methodtest/TEP1-FW/"       #place where the "filters" are stored/directory with imageJ results
#tabledir<-"C:/Users/lscheidemann/Desktop/Dokumrnte/imageJ-stuff"              #directory with input-table
#setwd(tabledir)
#input<-read_excel("Input_TEP_2.xlsx", col_names=TRUE, n_max=12) #files listed in csv, tsv or "fake"-xls
#input<-read_excel("TSP-tests.xlsx", sheet="Test1-FW", col_names=TRUE)
...
#filename                 <-"Test2-BE.xls"        #output filename
savedir                  <-"/Users/lscheidemann/Documents/"  #directory to save output in
